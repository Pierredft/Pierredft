...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Pierredft&layout=compact&theme=radical)
3. **Streak (series of commits)**
![GitHub Streak](https://streak-stats.demolab.com/?user=Pierredft&theme=radical)
...
## 🙋🏼‍♂️ À propos de moi !
Il y a deux ans, j'ai entrepris une reconversion professionnelle dans un milieu qui m'intéresse et me passionne. J'ai donc suivi une première formation qualifiante de "Développeur web et web mobile" qui a validé un niveau BAC+2 (niveau d'étude français) et une seconde formation qualifiante de "Concepteur développeur d'application" qui a validé un niveau BAC+3.
Je suis quelqu'un de curieux et qui aime ce qu'il fait, avec un attrait particulier pour les autres et un leadership naturel. J'aime aider et transmettre. Je sais me remettre en question. Pour moi, un échec n'est pas un problème, il fait partie de l'apprentissage et de l'évolution.

## Projet en cours 👨‍💻
Actuellement, je suis auto-entrepreneur et j'interviens sur des projets clients, mais je suis également formateur Concepteur Développeur d'Application, où je peux mettre ma pédagogie et mon expérience au service de particuliers en reconversion professionnelle.
Je travaille également sur un projet pour l'instant secret qui permettra d'améliorer le quotidien de personnes en situation d'handicap et également de leurs aidants.
